...
// Adsgram — Block ID واقعی، نوع Rewarded (جایگاه اول داخل لیست تسک‌های تبلیغاتی)
const ADSGRAM_CONFIG = { blockId: "38896" };

// Adsgram — Block ID واقعی دوم، نوع Rewarded Video (جایگاه دوم داخل لیست تسک‌های تبلیغاتی)
...
// Adsgram — Block ID واقعی، نوع Task (ویجت <adsgram-task>، جایگاه سوم داخل لیست تسک‌های تبلیغاتی)
...
// ----------------------------------------------------------------------------
const AD_NETWORKS = [
  { id: "adsgram", name: "Adsgram", reward: 15, cooldownSec: 12, blockId: ADSGRAM_CONFIG.blockId },
...
const MAIN_BOT_LINK = "https://t.me/coin_earn_2026bot";
